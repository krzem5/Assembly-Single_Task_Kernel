...
void ui_display_info_init(void){
	...
	_ui_display_info_mode_allocator=omm_init("ui_display_info_mode",sizeof(ui_display_info_mode_t),8,4,pmm_alloc_counter("omm_ui_display_info_mode"));
	spinlock_init(&(_ui_display_info_mode_allocator->lock));
}
