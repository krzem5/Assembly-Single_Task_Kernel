...
#define _VIRGL_PROTOCOL_COMMAND_HEADER(command,object,length) ((command)|((object)<<8)|((length)<<16))

#define VIRGL_PROTOCOL_COMMAND_NOP _VIRGL_PROTOCOL_COMMAND_HEADER(0,0,/*length*/0)
#define VIRGL_PROTOCOL_COMMAND_CREATE_OBJECT _VIRGL_PROTOCOL_COMMAND_HEADER(1,0,/*length*/0)
...
#define VIRGL_PROTOCOL_COMMAND_SET_VIEWPORT_STATE _VIRGL_PROTOCOL_COMMAND_HEADER(4,0,/*length*/0)
#define VIRGL_PROTOCOL_COMMAND_SET_FRAMEBUFFER_STATE _VIRGL_PROTOCOL_COMMAND_HEADER(5,0,/*length*/0)
#define VIRGL_PROTOCOL_COMMAND_SET_VERTEX_BUFFERS _VIRGL_PROTOCOL_COMMAND_HEADER(6,0,/*length*/0)
#define VIRGL_PROTOCOL_COMMAND_CLEAR _VIRGL_PROTOCOL_COMMAND_HEADER(7,0,/*length*/0)
...
#define VIRGL_PROTOCOL_COMMAND_SET_SUB_CTX _VIRGL_PROTOCOL_COMMAND_HEADER(28,0,/*length*/0)
#define VIRGL_PROTOCOL_COMMAND_CREATE_SUB_CTX _VIRGL_PROTOCOL_COMMAND_HEADER(29,0,1)
#define VIRGL_PROTOCOL_COMMAND_DESTROY_SUB_CTX _VIRGL_PROTOCOL_COMMAND_HEADER(30,0,/*length*/0)
...
#define VIRGL_PROTOCOL_COMMAND_MEMORY_BARRIER _VIRGL_PROTOCOL_COMMAND_HEADER(36,0,/*length*/0)
