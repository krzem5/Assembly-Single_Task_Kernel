...
#define VIRGL_PROTOCOL_COMMAND_DESTROY_OBJECT_SAMPLER_VIEW _VIRGL_PROTOCOL_COMMAND_HEADER(3,6,1)
#define VIRGL_PROTOCOL_COMMAND_DESTROY_OBJECT_SAMPLER_STATE _VIRGL_PROTOCOL_COMMAND_HEADER(3,7,1)
...
#define VIRGL_SWIZZLE_X 0
#define VIRGL_SWIZZLE_Y 1
#define VIRGL_SWIZZLE_Z 2
#define VIRGL_SWIZZLE_W 3
#define VIRGL_SWIZZLE_0 4
#define VIRGL_SWIZZLE_1 5

#define VIRGL_WRAP_REPEAT 0
#define VIRGL_WRAP_CLAMP_TO_EDGE 2
#define VIRGL_WRAP_CLAMP_TO_BORDER 3
#define VIRGL_WRAP_MIRROR_REPEAT 4

#define VIRGL_MIPFILTER_NEAREST 0
#define VIRGL_MIPFILTER_LINEAR 1
#define VIRGL_MIPFILTER_NONE 2

#define VIRGL_FILTER_NEAREST 0
#define VIRGL_FILTER_LINEAR 1

#define VIRGL_COMPARE_NONE 0
#define VIRGL_COMPARE_REF_TO_TEXTURE 1

#define VIRGL_COMPARE_FUNC_NEVER 0
#define VIRGL_COMPARE_FUNC_LESS 1
#define VIRGL_COMPARE_FUNC_EQUAL 2
#define VIRGL_COMPARE_FUNC_LEQUAL 3
#define VIRGL_COMPARE_FUNC_GREATER 4
#define VIRGL_COMPARE_FUNC_NOTEQUAL 5
#define VIRGL_COMPARE_FUNC_GEQUAL 6
#define VIRGL_COMPARE_FUNC_ALWAYS 7
