...
void test_elf(void){
	...
	// ################################ Negative tests ################################
	// invalid header: e_ident.signature ==> ERROR_INVALID_FORMAT
	// invalid header: e_ident.word_size ==> ERROR_INVALID_FORMAT
	// invalid header: e_ident.endianess ==> ERROR_INVALID_FORMAT
	// invalid header: e_ident.header_version ==> ERROR_INVALID_FORMAT
	// invalid header: e_ident.abi ==> ERROR_INVALID_FORMAT
	// invalid header: e_type ==> ERROR_INVALID_FORMAT
	// invalid header: machine ==> ERROR_INVALID_FORMAT
	// invalid header: version ==> ERROR_INVALID_FORMAT
