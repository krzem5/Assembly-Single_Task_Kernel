...
// 	fat32_filesystem_flush_root_block(&fs);
// 	fat32_node_t root_node;
// 	fat32_filesystem_get_root(&fs,&root_node);
...
// 			return 1;
// 		}
// 		if (!fat32_node_create(fs,&parent,child_name,strlen(child_name),KFS2_INODE_TYPE_DIRECTORY,&node)){
...
// 			return 1;
// 		}
// 		if (!fat32_node_create(fs,&parent,child_name,strlen(child_name),KFS2_INODE_TYPE_FILE,&node)){
...
int main(int argc,const char** argv){
	...
	(void)_alloc_callback;
	(void)_dealloc_callback;
