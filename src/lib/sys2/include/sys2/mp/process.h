...
sys2_error_t sys2_process_get_termination_event(sys2_process_t process);
...
sys2_error_t sys2_process_start(const char* path,u32 argc,const char*const* argv,const char*const* environ,u32 flags);
