...
#define SYS2_SOCKET_DOMAIN_NONE 0
#define SYS2_SOCKET_DOMAIN_INET 1
#define SYS2_SOCKET_DOMAIN_INET6 2
#define SYS2_SOCKET_DOMAIN_UNIX 3

#define SYS2_SOCKET_TYPE_NONE 0
#define SYS2_SOCKET_TYPE_STREAM 1
#define SYS2_SOCKET_TYPE_DGRAM 2

#define SYS2_SOCKET_PROTOCOL_NONE 0
#define SYS2_SOCKET_PROTOCOL_TCP 6
#define SYS2_SOCKET_PROTOCOL_UDP 17
