...
SYS2_PUBLIC sys2_error_t sys2_fd_open(sys2_fd_t fd,const char* path,u32 flags){
...
SYS2_PUBLIC sys2_error_t sys2_fd_read(sys2_fd_t fd,void* buffer,u64 size,u32 flags){
	return _sys2_syscall_fd_read(fd,buffer,size,flags);
}



SYS2_PUBLIC sys2_error_t sys2_fd_write(sys2_fd_t fd,const void* buffer,u64 size,u32 flags){
	return _sys2_syscall_fd_write(fd,buffer,size,flags);
}



SYS2_PUBLIC sys2_error_t sys2_fd_seek(sys2_fd_t fd,u64 offset,u32 type){
	return _sys2_syscall_fd_seek(fd,offset,type);
}



SYS2_PUBLIC sys2_error_t sys2_fd_resize(sys2_fd_t fd,u64 size,u32 flags){
...
SYS2_PUBLIC sys2_error_t sys2_fd_dup(sys2_fd_t fd,u32 flags){
...
SYS2_PUBLIC sys2_error_t sys2_fd_iter_start(sys2_fd_t fd){
...
SYS2_PUBLIC sys2_error_t sys2_fd_iter_next(sys2_fd_iterator_t iterator){
