...
static void* _get_handle(GLuint handle,opengl_handle_type_t type,_Bool always_invalid_operation,_Bool alwats_invalid_value){
	...
	if (_gl_internal_state->handles[handle]->type!=type){
		_gl_internal_state->gl_error=(alwats_invalid_value?GL_INVALID_VALUE:GL_INVALID_OPERATION);
		return NULL;
	}
...
static void _sync_state(void){
	...
	opengl_vertex_array_state_t* state=_get_handle(_gl_internal_state->gl_used_vertex_array,OPENGL_HANDLE_TYPE_VERTEX_ARRAY,1,0);
	if (!state){
		goto _skip_vertex_array_sync;
	}
...
_skip_vertex_array_sync:
	...
	if (_gl_internal_state->gl_constant_buffer_needs_update){
		opengl_program_state_t* program_state=_get_handle(_gl_internal_state->gl_used_program,OPENGL_HANDLE_TYPE_PROGRAM,1,0);
	...
	if (_gl_internal_state->gl_bound_array_buffer!=_gl_internal_state->gl_used_array_buffer){
		opengl_buffer_state_t* array_buffer_state=_get_handle(_gl_internal_state->gl_used_array_buffer,OPENGL_HANDLE_TYPE_BUFFER,1,0);
		opengl_vertex_array_state_t* state=_get_handle(_gl_internal_state->gl_used_vertex_array,OPENGL_HANDLE_TYPE_VERTEX_ARRAY,1,0);
		if (!state){
...
static void _update_buffer_data(GLenum target,GLintptr offset,GLsizeiptr size,const void* data,GLuint new_storage_type){
	...
	opengl_buffer_state_t* state=_get_handle(id,OPENGL_HANDLE_TYPE_BUFFER,1,0);
	if (!state){
		return;
	}
	if (state->is_mapped){
...
static void _set_vertex_attrib(GLuint index,GLint size,GLenum type,GLboolean normalized,const void* data,GLuint data_size){opengl_vertex_array_state_t* state=_get_handle(_gl_internal_state->gl_used_vertex_array,OPENGL_HANDLE_TYPE_VERTEX_ARRAY,1,0);
	if (!state){
		return;
	}
...
_enum_error:
	...
	u32 protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_NONE;
	if (!is_update){
		switch (internalformat){
			case GL_RGBA32F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA32F;
				break;
			case GL_RGBA32I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA32I;
				break;
			case GL_RGBA32UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA32UI;
				break;
			case GL_RGBA16:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA16;
				break;
			case GL_RGBA16F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA16F;
				break;
			case GL_RGBA16I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA16I;
				break;
			case GL_RGBA16UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA16UI;
				break;
			case GL_RGBA8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA8;
				break;
			case GL_RGBA8UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA8UI;
				break;
			case GL_SRGB8_ALPHA8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_SRGB8_ALPHA8;
				break;
			case GL_RGB10_A2:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB10_A2;
				break;
			case GL_RGB10_A2UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB10_A2UI;
				break;
			case GL_R11F_G11F_B10F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R11F_G11F_B10F;
				break;
			case GL_RG32F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG32F;
				break;
			case GL_RG32I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG32I;
				break;
			case GL_RG32UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG32UI;
				break;
			case GL_RG16:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG16;
				break;
			case GL_RG16F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG16F;
				break;
			case GL_RGB16I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB16I;
				break;
			case GL_RGB16UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB16UI;
				break;
			case GL_RG8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG8;
				break;
			case GL_RG8I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG8I;
				break;
			case GL_RG8UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG8UI;
				break;
			case GL_R32F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R32F;
				break;
			case GL_R32I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R32I;
				break;
			case GL_R32UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R32UI;
				break;
			case GL_R16F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R16F;
				break;
			case GL_R16I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R16I;
				break;
			case GL_R16UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R16UI;
				break;
			case GL_R8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R8;
				break;
			case GL_R8I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R8I;
				break;
			case GL_R8UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R8UI;
				break;
			case GL_RGBA16_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA16_SNORM;
				break;
			case GL_RGBA8_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGBA8_SNORM;
				break;
			case GL_RGB32F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB32F;
				break;
			case GL_RGB32I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB32I;
				break;
			case GL_RGB32UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB32UI;
				break;
			case GL_RGB16_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB16_SNORM;
				break;
			case GL_RGB16F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB16F;
				break;
			case GL_RGB16:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB16;
				break;
			case GL_RGB8_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB8_SNORM;
				break;
			case GL_RGB8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB8;
				break;
			case GL_RGB8I:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB8I;
				break;
			case GL_RGB8UI:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB8UI;
				break;
			case GL_SRGB8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_SRGB8;
				break;
			case GL_RGB9_E5:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RGB9_E5;
				break;
			case GL_RG16_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG16_SNORM;
				break;
			case GL_RG8_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_RG8_SNORM;
				break;
			case GL_COMPRESSED_RG_RGTC2:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_COMPRESSED_RG_RGTC2;
				break;
			case GL_COMPRESSED_SIGNED_RG_RGTC2:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_COMPRESSED_SIGNED_RG_RGTC2;
				break;
			case GL_R16_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R16_SNORM;
				break;
			case GL_R8_SNORM:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_R8_SNORM;
				break;
			case GL_COMPRESSED_RED_RGTC1:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_COMPRESSED_RED_RGTC1;
				break;
			case GL_COMPRESSED_SIGNED_RED_RGTC1:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_COMPRESSED_SIGNED_RED_RGTC1;
				break;
			case GL_DEPTH_COMPONENT32F:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_DEPTH_COMPONENT32F;
				break;
			case GL_DEPTH_COMPONENT24:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_DEPTH_COMPONENT24;
				break;
			case GL_DEPTH_COMPONENT16:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_DEPTH_COMPONENT16;
				break;
			case GL_DEPTH32F_STENCIL8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_DEPTH32F_STENCIL8;
				break;
			case GL_DEPTH24_STENCIL8:
				protocol_format=OPENGL_PROTOCOL_TEXTURE_FORMAT_DEPTH24_STENCIL8;
				break;
			default:
				_gl_internal_state->gl_error=GL_INVALID_ENUM;
				return;
...
SYS_PUBLIC void glAttachShader(GLuint program,GLuint shader){
	opengl_program_state_t* state=_get_handle(program,OPENGL_HANDLE_TYPE_PROGRAM,0,0);
	if (!state){
		return;
	}
	opengl_shader_state_t* shader_state=_get_handle(shader,OPENGL_HANDLE_TYPE_SHADER,0,0);
	if (!state){
		return;
	}
...
SYS_PUBLIC void glBindBuffer(GLenum target,GLuint buffer){
	if (buffer&&!_get_handle(buffer,OPENGL_HANDLE_TYPE_BUFFER,1,0)){
		return;
	}
	switch (target){
		case GL_ARRAY_BUFFER:
...
SYS_PUBLIC void glBindTexture(GLenum target,GLuint texture){
	opengl_texture_state_t* state=NULL;
	if (texture){
		state=_get_handle(texture,OPENGL_HANDLE_TYPE_TEXTURE,0,1);
		if (!state){
			return;
		}
	...
	switch (target){
		case GL_TEXTURE_2D:
			_gl_internal_state->gl_used_texture_2d=texture;
			break;
		default:
...
SYS_PUBLIC void glBindVertexArray(GLuint array){
	if (array&&!_get_handle(array,OPENGL_HANDLE_TYPE_VERTEX_ARRAY,1,0)){
		return;
	}
...
SYS_PUBLIC void glCompileShader(GLuint shader){
	opengl_shader_state_t* state=_get_handle(shader,OPENGL_HANDLE_TYPE_SHADER,0,0);
	if (!state){
		return;
	}
...
SYS_PUBLIC GLboolean glIsBuffer(GLuint buffer){
	GLenum error=_gl_internal_state->gl_error;
	void* ptr=_get_handle(buffer,OPENGL_HANDLE_TYPE_BUFFER,1,0);
	_gl_internal_state->gl_error=error;
	return !!ptr;
}
...
SYS_PUBLIC GLboolean glIsProgram(GLuint program){
	GLenum error=_gl_internal_state->gl_error;
	void* ptr=_get_handle(program,OPENGL_HANDLE_TYPE_PROGRAM,1,0);
	_gl_internal_state->gl_error=error;
	return !!ptr;
}
...
SYS_PUBLIC GLboolean glIsShader(GLuint shader){
	GLenum error=_gl_internal_state->gl_error;
	void* ptr=_get_handle(shader,OPENGL_HANDLE_TYPE_SHADER,1,0);
	_gl_internal_state->gl_error=error;
	return !!ptr;
}
...
SYS_PUBLIC GLboolean glIsVertexArray(GLuint array){
	GLenum error=_gl_internal_state->gl_error;
	void* ptr=_get_handle(array,OPENGL_HANDLE_TYPE_VERTEX_ARRAY,1,0);
	_gl_internal_state->gl_error=error;
	return !!ptr;
}
