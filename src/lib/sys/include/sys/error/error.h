...
#define SYS_ERROR_FAILED _SYS_BUILD_ERROR(0x0010)
#define SYS_ERROR_MASKED _SYS_BUILD_ERROR(0x0011)
#define SYS_ERROR_SIGNAL(signal) _SYS_BUILD_ERROR((0x0012|((signal)<<16)))
#define SYS_ERROR_LINK_FOUND _SYS_BUILD_ERROR(0x0013)
#define SYS_ERROR_INTERRUPTED _SYS_BUILD_ERROR(0x0014)
#define SYS_ERROR_ALREADY_MAPPED _SYS_BUILD_ERROR(0x0015)
