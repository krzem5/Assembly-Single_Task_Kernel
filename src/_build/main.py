...
def _compile_kernel(force_patch_kernel):
	...
	object_files=[]
	pool=process_pool.ProcessPool(file_hash_list)
	for file in _get_files([KERNEL_FILE_DIRECTORY,COMMON_FILE_DIRECTORY+"/aes",COMMON_FILE_DIRECTORY+"/hash"]):
