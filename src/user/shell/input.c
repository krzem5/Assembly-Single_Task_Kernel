...
void input_get(void){
	...
	while (1){
		sys_io_print("\x1b[G\x1b[2K\x1b[\x1b[1m\x1b[32m%s\x1b[0m:\x1b[1m\x1b[34m%s\x1b[0m$ %s\x1b[%uG",uid_name_buffer,cwd,_input_history[_input_history_index].data,_input_cursor+cwd_length+8);
		int key=_get_key();
