...
#define PMM_COUNTER_AML 1
#define PMM_COUNTER_CPU 2
#define PMM_COUNTER_DRIVER_AHCI 3
#define PMM_COUNTER_DRIVER_I82540 4
#define PMM_COUNTER_KERNEL_STACK 5
#define PMM_COUNTER_KFS 6
#define PMM_COUNTER_NETWORK 7
#define PMM_COUNTER_NODE_ALLOCATOR 8
#define PMM_COUNTER_PMM 9
#define PMM_COUNTER_USER 10
#define PMM_COUNTER_USER_STACK 11
#define PMM_COUNTER_VMM 12
