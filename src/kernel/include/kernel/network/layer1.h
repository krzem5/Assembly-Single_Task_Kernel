...
network_layer1_packet_t* network_layer1_create_packet(u16 length,const mac_address_t* src_mac_address,const mac_address_t* dst_mac_address,ether_type_t ether_type);
...
network_layer1_packet_t* network_layer1_pop_packet(void);
