...
#define INFO_CORE(template,...) _LOG("\x1b[38;2;182;182;182m",template,##__VA_ARGS__)
#define LOG_CORE(template,...) _LOG("\x1b[1m\x1b[38;2;242;242;242m",template,##__VA_ARGS__)
#define WARN_CORE(template,...) _LOG("\x1b[38;2;231;211;72m",template,##__VA_ARGS__)
#define ERROR_CORE(template,...) _LOG("\x1b[1m\x1b[38;2;231;72;86m",template,##__VA_ARGS__)
