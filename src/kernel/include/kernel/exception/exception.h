...
#define _EXCEPTION_UNWIND_REF_ARGS_(_1,_2,_3,_4,_5,_6,_7,_8,N,...) _EXCEPTION_UNWIND_REF_ARGS_##N
#define _EXCEPTION_UNWIND_REF_ARGS(...) _EXCEPTION_UNWIND_REF_ARGS_(__VA_ARGS__,8,7,6,5,4,3,2,1,0)(__VA_ARGS__)
