...
void KERNEL_NOCOVERAGE KERNEL_EARLY_EXEC __lock_profiling_enable_dependency_graph(void){
...
KERNEL_PUBLIC const lock_profiling_type_descriptor_t* KERNEL_INIT_WRITE lock_profiling_type_descriptors=NULL;
KERNEL_PUBLIC const lock_profiling_data_descriptor_t* KERNEL_INIT_WRITE lock_profiling_data_descriptor_head=NULL;
