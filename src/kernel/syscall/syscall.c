...
void syscall_init(void){
	...
	_syscall_handlers[17]=syscall_fd_stat;
	_syscall_handlers[18]=syscall_fd_get_relative;
	_syscall_handlers[19]=syscall_fd_move;
	_syscall_handlers[20]=syscall_network_layer1_config;
	_syscall_handlers[21]=syscall_network_layer2_send;
	_syscall_handlers[22]=syscall_network_layer2_poll;
	_syscall_handlers[23]=syscall_network_layer3_refresh;
	_syscall_handlers[24]=syscall_network_layer3_device_count;
	_syscall_handlers[25]=syscall_network_layer3_device_get;
	_syscall_handlers[26]=syscall_network_layer3_device_delete;
	_syscall_handlers[27]=syscall_system_shutdown;
	_syscall_handlers[28]=syscall_system_config;
	_syscall_handlers[29]=syscall_memory_map;
	_syscall_handlers[30]=syscall_memory_unmap;
	_syscall_handlers[31]=syscall_memory_stats;
	_syscall_handlers[32]=syscall_clock_get_converion;
	_syscall_handlers[33]=syscall_drive_format;
	_syscall_handlers[34]=syscall_drive_stats;
